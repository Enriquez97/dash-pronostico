...
def textInput(label="",ids=None,required=False,size="sm",error=False,descripcion='',value=None):
    return html.Div([dmc.TextInput(label=label,id=ids,required=required,size=size,error=error,description=descripcion,value=value),]) 
